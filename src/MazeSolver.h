...
class MazeSolver
{
	public:
		...
		static std::vector<int> MazeSolver::DepthFirstSearch(std::vector<std::vector<int> > walls);
		static std::vector<int> MazeSolver::OptimizedDFS(std::vector<std::vector<int> > walls);
